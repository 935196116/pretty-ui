<template>
    <button :disabled="!(disabled===false)" @click="$emit('click')" class="xy-button" :style="buttonStyleString"><svg v-if="!(loading===false)" class="xy-loading-img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
     width="32" height="32"
     viewBox="0 0 252 252"
